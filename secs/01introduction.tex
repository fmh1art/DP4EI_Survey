...
Fourth, industrial foundation-model reports now disclose sufficiently different
recipes to support structural synthesis: Qwen foregrounds representation,
motion, and behavior alignment; the $\pi$ family exposes stage- and
metadata-dependent routing; GR00T combines real anchors with neural/simulated
expansion; and Gemini reports cross-embodiment Motion Transfer
...
has become a first-class systems architecture.
...
This survey makes seven visible contributions.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{An auditable evidence map.}  We organize 211 papers and system
    ...
    \item \textbf{Industrial-recipe and data-engine synthesis.}  We reconstruct
    public recipes for Qwen, Physical Intelligence, GR00T, and Gemini Robotics;
    compare engines by feedback, data action, update, and safeguard; and separate
    disclosed facts, within-paper evidence, and our inference.
    \item \textbf{Cross-domain and evolutionary synthesis.}  We reconcile
    conflicts about filtering, diversity, and failed data, transfer mechanisms
    rather than text heuristics from LLM data engineering, and derive a five-level
    path from static curation to an auditable data-preparation agent.
...
LLM-derived mechanisms, and cross-cutting conclusions, before
