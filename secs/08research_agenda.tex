...
its final aggregate success is high.
...
policy while remaining auditable.  It is falsified if learned pipelines fail to
transfer beyond their calibration learner, consume more total resources than
fixed baselines, or amplify errors across rounds.  Stating these failure criteria
is important: ``automation'' alone is not an academic contribution unless it
improves the correctness--coverage--cost frontier under controlled evidence.
