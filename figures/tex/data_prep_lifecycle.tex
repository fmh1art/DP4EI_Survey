...
\node[stage] (raw) {\textbf{Raw records}\\robot, human video, simulation, generated, deployment};
\node[stage, right=of raw] (ops) {\textbf{Operations}\\validate, align, segment, label, filter, weight, synthesize};
\node[stage, right=of ops] (dist) {\textbf{Prepared training data}\\unit, role, weight, provenance, version};
